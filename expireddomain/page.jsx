...
import { createExpiredDomainsAgent } from "../../lib/ExpiredDomainAgent"
...
export default function ExpiredDomainsPage() {
  ...
  useEffect(() => {
    if (!agentRef.current) agentRef.current = createExpiredDomainsAgent()
  }, [])
      ...
      setMessages([
        {
          id: uuidv4(),
          role: "assistant",
          content: `🌐 Welcome to Goblin Pro! I'm your AI-powered assistant for finding and analyzing expired domains.\n\n✨ Here's what I can help you with:\n\n🔍 Finding expired/available domains\n📊 Analyzing domain metrics (backlinks, age, etc.)\n💡 Recommending valuable domains for SEO\n📈 Providing domain statistics and trends\n\nWhat kind of domains are you looking for today?`,
